...
export class ProfileService {
  ...
  putUpdateUserPhoto(data: FormData): Observable<string> {
    return this.httpClient.put<string>(`${this.baseUrl}updateUserPhoto`, data);
  }

  postBanUser(userName: string) : Observable<string>{
    return this.httpClient.post<string>(`${this.baseUrl}banUser/${userName}`, userName)
  }
